...
public:
    ...
    virtual bool ContainsPoint(QPoint &point) const = 0;
    //clone
...
//debugging methods
public:
    virtual QPoint &GetLocalCoordinate(QPoint &global_coordinate) = 0;
    virtual QPoint &GetGlobalCoordinate(QPoint &local_coordinate) = 0;
};
